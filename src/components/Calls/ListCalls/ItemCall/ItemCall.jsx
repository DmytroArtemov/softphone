...
const ItemCall = (props) => {
    ...
    switch(props.destinationType) {
        case 1: destinationType = <path d="M11.6357 0.643066H9.93615C9.61264 0.643066 9.44921 1.0356 9.67855 1.26496L10.164 1.75048L7.19617 4.71834C7.12504 4.78947 7.12504 4.9048 7.19617 4.97594L7.66715 5.44692C7.73829 5.51805 7.85362 5.51805 7.92475 5.44692L10.8926 2.47908L11.3781 2.96466C11.6063 3.19275 12 3.03259 12 2.70706V1.00736C12 0.806162 11.8369 0.643066 11.6357 0.643066Z" fill="currentColor"/>; break;
        case 2: destinationType = <path d="M7.50733 5.5H9.20692C9.53042 5.5 9.69385 5.10746 9.46452 4.87811L8.97904 4.39259L11.9469 1.42473C12.018 1.3536 12.018 1.23827 11.9469 1.16713L11.4759 0.696145C11.4048 0.625017 11.2894 0.625017 11.2183 0.696145L8.25047 3.66399L7.76493 3.17841C7.53681 2.95031 7.14304 3.11048 7.14304 3.436V5.13571C7.14304 5.3369 7.30614 5.5 7.50733 5.5Z" fill="currentColor"/>; break;
        case 3: destinationType = ''; break;
        case 4: destinationType = ''; break;
        default: destinationType = '';
    }

    switch(props.status) {
        case 1: status = ''; break;
        case 2: status = 'answered'; break;
        case 3: status = 'not-answered'; break;
        case 4: status = ''; break;
        default: status = '';
    }
    ...
    return(
        <li className="user-item" onClick={addCalls}>
            ...
            <div className="info">
                ...
                {props.type===2 ? <div className="warning status-iternal">Internal</div> : ''}
            </div>
