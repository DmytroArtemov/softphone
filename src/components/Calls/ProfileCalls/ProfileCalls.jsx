        ...
        <section className="element-profile">
            <div className="profile-head">
                <div className="col-info">
                    <div className="date">
                        <div><span className="month">Dec</span> <span className="day">12</span></div>
                        <div><span className="time">14:05</span></div>
                    </div>
                    <div className="client">
                        <p className="number">206</p>
                        <span className="name">Valerii Artemenko</span>
                    </div>
                    <ul className="tags">
                ...
                <div className="col-phone">
                    <div className="get-call">
                        <div className="icon">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M19.2731 0.960383L15.2106 0.0228834C14.7692 -0.0786792 14.3161 0.15179 14.1364 0.565852L12.2614 4.94085C12.0973 5.32367 12.2067 5.77288 12.5309 6.0346L14.8981 7.9721C13.4919 10.9682 11.0348 13.4604 7.97624 14.894L6.03874 12.5268C5.77311 12.2026 5.3278 12.0932 4.94499 12.2573L0.569987 14.1323C0.152018 14.3159 -0.0784506 14.769 0.023112 15.2104L0.960612 19.2729C1.05827 19.6948 1.43327 19.9994 1.87467 19.9994C11.8786 19.9994 19.9997 11.894 19.9997 1.87445C19.9997 1.43695 19.6989 1.05804 19.2731 0.960383Z" fill="currentColor"/></svg>    
                        </div>
                    </div>
                </div>
            </div>
            <div className="profile-body">
                <div className="col-left">
                    ...
                    <a href="/" className="btn btn-secondary link-show-pbx">Show more on PBX</a>
                </div>
            </div>
        </section>
    )
