...
import { getSeparateContact } from '../../../../redux/users/user-operation';
import './ItemContact.scss';

const ItemContact = ({ phone, firstName, lastName, favorite, contactId }) => {
  const dispatch = useDispatch();
  return (
    <li
      className='item-contact'
      onClick={() => {
        dispatch(getSeparateContact(contactId));
      }}
    >
      ...
      {favorite ? (
        <div className={favorite ? 'favorite' : 'not'}>
          <div className='icon'>
            <svg
              width='14'
              height='14'
            ...
            >
              <path
                d='M6.33863 1.28355L4.74245 4.51989L1.17123 5.04055C0.530809 5.13343 0.27415 5.92296 0.73858 6.37517L3.32228 8.89287L2.71118 12.4494C2.60119 13.0923 3.27828 13.5738 3.84537 13.2732L7.04016 11.5939L10.235 13.2732C10.802 13.5714 11.4791 13.0923 11.3691 12.4494L10.758 8.89287L13.3417 6.37517C13.8062 5.92296 13.5495 5.13343 12.9091 5.04055L9.33787 4.51989L7.74169 1.28355C7.4557 0.706681 6.62706 0.699348 6.33863 1.28355Z'
                fill='#FFC754'
              />
            </svg>
          </div>
