            ...
            <div className="profile-head">
                <div className="col-info">
                    <div className="client">
                        <p className="name">
                            <i>Valerii Artemenko </i>
                            {/* если favorite = false */}
                            <div className="favorite"><svg width="22" height="21" viewBox="0 0 22 21" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M10.0079 1.42533L7.61368 6.27984L2.25685 7.06082C1.29621 7.20015 0.911225 8.38444 1.60787 9.06276L5.48342 12.8393L4.56678 18.1741C4.40178 19.1384 5.41742 19.8607 6.26806 19.4098L11.0602 16.8908L15.8524 19.4098C16.7031 19.8571 17.7187 19.1384 17.5537 18.1741L16.6371 12.8393L20.5126 9.06276C21.2093 8.38444 20.8243 7.20015 19.8636 7.06082L14.5068 6.27984L12.1125 1.42533C11.6836 0.560022 10.4406 0.549022 10.0079 1.42533Z" stroke="#A6B4D0"/></svg></div>
                            {/* если favorite = true */}
                            <div className="favorite"><svg width="22" height="21" viewBox="0 0 22 21" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M10.0079 1.42533L7.61368 6.27984L2.25685 7.06082C1.29621 7.20015 0.911225 8.38444 1.60787 9.06276L5.48342 12.8393L4.56678 18.1741C4.40178 19.1384 5.41742 19.8607 6.26806 19.4098L11.0602 16.8908L15.8524 19.4098C16.7031 19.8571 17.7187 19.1384 17.5537 18.1741L16.6371 12.8393L20.5126 9.06276C21.2093 8.38444 20.8243 7.20015 19.8636 7.06082L14.5068 6.27984L12.1125 1.42533C11.6836 0.560022 10.4406 0.549022 10.0079 1.42533Z" fill="#FFC754"/></svg></div>
                        </p>
